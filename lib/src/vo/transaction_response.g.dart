...
TransactionResponse _$TransactionResponseFromJson(
  ...
  senders: (json['senders'] as List<dynamic>).map((e) => e as String).toList(),
  signers: (json['signers'] as List<dynamic>).map((e) => e as String).toList(),
